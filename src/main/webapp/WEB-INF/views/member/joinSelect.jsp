...
<div class="container my-5">
  <div class="p-5 text-center bg-body-tertiary rounded-3">
    ...
    <div class="d-inline-flex gap-2 mb-5">
      <a href="/member/joinCheck" class="btn btn-primary btn-lg px-4 rounded-pill" role="button">
        일반회원가입
      </a>
      <a href = "/member/operJoinForm" class="btn btn-outline-secondary btn-lg px-4 rounded-pill" type="button">
        사업자회원가입
      </a>
    </div>
  </div>
