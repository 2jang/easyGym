                ...
                <main> <!-- ------------------------------------main---------------------------------------------- -->
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/admin/noticeList">메인으로</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                                        ...
                                                        <td id="title">
                                                            <c:choose>
                                                                <c:when test="${notice.noticeCategory == '1'}">
                                                                    ...
                                                                    <a href="/admin/viewNotice?noticeNo=${notice.noticeNo}">${notice.noticeTitle}</a>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <a href="/admin/viewNotice?noticeNo=${notice.noticeNo}">${notice.noticeTitle}</a>
                                                                </c:otherwise>
								...
								<a href="javascript:fn_noticeForm(${sessionScope.isLogOn}, '/admin/noticeForm', '/admin/loginForm');">글쓰기</a>
                            </div>
                        </div>
                    </div>
                </main>
